...
//   for (let i = 0; i < allUserIps.length; i++) {
//     let [userId, ip] = allUserIps[i].split(",");
//     userTrack[userId] = ip;
//   }
//   console.log(userTrack);

//   for (let i = 0; i < adClicks.length; i++) {
//     let adClick = adClicks[i];
//     let [ipAddress, time, adText] = adClick.split(",");
//     if (!clickTrack[ipAddress]) clickTrack[ipAddress] = {};
//     if (!clickTrack[ipAddress[adText]]) clickTrack[ipAddress][adText] = 0;
//     clickTrack[ipAddress][adText]++;
//   }
//   console.log(clickTrack);

//   for (let j = 0; j < completedPurchaseUserIds.length; j++) {
//     let ipID = userTrack[completedPurchaseUserIds[j]];
//     console.log(ipID);
//     console.log(clickTrack[ipID]);
//   }
// }
function adsConversionRate(completedPurchaseUserIds, adClicks, allUserIps) {
...
const completedPurchaseUserIds = [
  "3123122444",
  "234111110",
  "8321125440",
  "99911063",
...
console.log(adsConversionRate(completedPurchaseUserIds, adClicks, allUserIps));
